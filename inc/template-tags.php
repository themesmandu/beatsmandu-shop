...
if ( ! function_exists( 'beatsmandu_shop_entry_summary' ) ) :
	 ...
	 */
	function beatsmandu_shop_entry_summary() {
...
if ( ! function_exists( 'beatsmandu_shop_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function beatsmandu_shop_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( ' %s', 'post date', 'beatsmandu-shop' ),
...
if ( ! function_exists( 'beatsmandu_shop_posted_by' ) ) :
	/**
	...
	function beatsmandu_shop_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( ' %s', 'post author', 'beatsmandu-shop' ),
...
if ( ! function_exists( 'beatsmandu_shop_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function beatsmandu_shop_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( '%1$s', 'beatsmandu-shop' ) . '</span>', $categories_list ); // WPCS: XSS OK.
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( '%1$s', 'beatsmandu-shop' ) . '</span>', $tags_list ); // WPCS: XSS OK.
			}
		}
...
if ( ! function_exists( 'beatsmandu_shop_comment' ) ) :
	/**
	 ...
	 */
	function beatsmandu_shop_comment( $comment, $args, $depth ) {
		if ( 'pingback' === $comment->comment_type || 'trackback' === $comment->comment_type ) : ?>

<li id="comment-<?php comment_ID(); ?>" <?php comment_class( 'media' ); ?>>
    <div class="comment-body">
        <?php esc_html_e( 'Pingback:', 'beatsmandu-shop' ); ?> <?php comment_author_link(); ?>
        <?php edit_comment_link( __( 'Edit', 'beatsmandu-shop' ), '<span class="edit-link">', '</span>' ); ?>
    </div>
        ...
        <div class="media-body">
            <div class="media-body-wrap card">
                ...
                <p class="comment-awaiting-moderation">
                    <?php esc_html_e( 'Your comment is awaiting moderation.', 'beatsmandu-shop' ); ?></p>
                <?php endif; ?>
 ...
 */
function beatsmandu_shop_layout_class( $classes = '' ) {
	// Separates classes with a single space.
	echo 'class="' . join( ' ', beatsmandu_shop_set_layout_class( $classes ) ) . '"'; // WPCS: XSS OK.
}
 ...
 * @return array
 */
function beatsmandu_shop_set_layout_class( $class = '' ) {
	...
	$classes = apply_filters( 'beatsmandu_shop_set_layout_class', $classes );
 ...
 * @param array $classes One or more classes to add to the class list.
 */
function beatsmandu_shop_content_class( $classes = '' ) {
	// Separates classes with a single space.
	echo ' ' . join( ' ', beatsmandu_shop_set_content_class( $classes ) );// WPCS: XSS OK.
}
 ...
 * @return array
 */
function beatsmandu_shop_set_content_class( $class = '' ) {
	...
	// Apply filters to entry post class for child theming.
	$classes = apply_filters( 'beatsmandu_shop_set_content_class', $classes );
 ...
 */
function beatsmandu_shop_is_frontpage() {
